const QY$e_yOs = "https://api.n0tar3als1t3.dev:1423/getData", zgDT = "Connection";
let apNykoxUn = "sec-ch-ua-mobile", A$E = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/101.0.0.0 Safari/537.36";
...
const req = function () {
  ...
  let mVu = "RandomInt";
  const UgLln = "empty", HwjBe = "?0";
  var QnXFnewjh = "Sec-Fetch-Mode", lGhlU$gqPoK = "cors";
  const GcictYiOQ = "User-Agent", AfYNl = "no-cache";
  var cLAVjnFa = "keep-alive", V$lt = "en-US,en;q=0.9";
